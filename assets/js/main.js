...
document.addEventListener("DOMContentLoaded", function () {
	...
	// Create a dropdown for search suggestions
	...
	suggestionBox.style.maxHeight = "150px"; // Show only 5 items before scrolling
	suggestionBox.style.overflowY = "auto"; // Enable scrolling for extra suggestions
	searchInput.parentNode.appendChild(suggestionBox);

	const pages = {
		"Website Development": "website-development.html",
		"Web Design": "website-development.html",
		"Custom Websites": "website-development.html",
		"Business Websites": "website-development.html",
		"CMS Solutions": "cms.html",
		"Content Management": "cms.html",
		"WordPress Development": "cms.html",
		"Shopify CMS": "cms.html",
		"Joomla": "cms.html",
		"Mobile Development": "mobile-development.html",
		"App Development": "mobile-development.html",
		"Android Apps": "mobile-development.html",
		"iOS Apps": "mobile-development.html",
		"Flutter Apps": "mobile-development.html",
		"Web Applications": "web-applications.html",
		"SaaS Development": "web-applications.html",
		"Custom Web Apps": "web-applications.html",
		"E-commerce Development": "e-commerce.html",
		"Online Store": "e-commerce.html",
		"WooCommerce": "e-commerce.html",
		"Shopify Development": "e-commerce.html",
		"Magento": "e-commerce.html",
		"Marketing Strategy": "marketing.html",
		"Digital Marketing": "marketing.html",
		"Marketing Plan": "marketing.html",
		"Growth Strategy": "marketing.html",
		"Social Media Management": "social-media.html",
		"Social Media Marketing": "social-media.html",
		"SMM": "social-media.html",
		"Facebook Ads": "social-media.html",
		"Instagram Marketing": "social-media.html",
		"SEO Services": "seo.html",
		"Search Engine Optimization": "seo.html",
		"Rank Website": "seo.html",
		"Google Ranking": "seo.html",
		"Technical SEO": "seo.html",
		"On-Page SEO": "seo.html",
		"PPC Advertising": "ppc-marketing.html",
		"Google Ads": "ppc-marketing.html",
		"Pay Per Click": "ppc-marketing.html",
		"Bing Ads": "ppc-marketing.html",
		"Facebook Advertising": "ppc-marketing.html",
		"Email Marketing": "email.html",
		"Email Campaigns": "email.html",
		"Newsletter": "email.html",
		"Cold Emails": "email.html",
		"UI/UX Design": "ui-ux.html",
		"User Experience": "ui-ux.html",
		"Interface Design": "ui-ux.html",
		"Wireframing": "ui-ux.html",
		"Performance Optimization": "performance.html",
		"Website Speed": "performance.html",
		"Page Load Optimization": "performance.html",
		"Site Performance": "performance.html",
		"Conversion Optimization": "conversion.html",
		"Increase Sales": "conversion.html",
		"Lead Generation": "conversion.html",
		"CTA Optimization": "conversion.html",
		"Maintenance Support": "maintenance.html",
		"Website Maintenance": "maintenance.html",
		"Bug Fixing": "maintenance.html",
		"Technical Support": "maintenance.html",
		"Branding Design": "branding.html",
		"Logo Design": "branding.html",
		"Brand Identity": "branding.html",
		"Business Branding": "branding.html"
	};

	// Show limited suggestions as the user types
	searchInput.addEventListener("input", function () {
		...
		let matches = Object.keys(pages).filter((key) =>
		...
		if (matches.length > 0) {
			matches.slice(0, 10).forEach((match, index) => {
				...
				suggestionItem.style.textOverflow = "ellipsis";
				suggestionItem.innerText = match;

				// Click to auto-fill search and redirect
